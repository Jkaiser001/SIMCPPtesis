...
cout<<endl;
  ...
  printf("cache L1= %dKB  L2= %dKB L3= %dMB Latencia gL1L2= %lf gL2L3= %lf  gL3Ram= %lf\n",
         (entradas_L1*8*64)/1024, (entradas_L2*8*64)/1024,(entradas_L3*8*64)/(1024*1024),
         Latencia_G_L1_L2, Latencia_G_L2_L3, Latencia_G_L3_Ram );
