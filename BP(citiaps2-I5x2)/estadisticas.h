...
void completarCores(){
  ...
  */
  ...
  void mideCacheL1(int cpid,int id_core,double diferencia,double tiempo_total, double tiempothread){
      ...
      dataCache *dataC = new dataCache(tiempoActivo,tiempo_total,lecturas[id_core][0],escrituras[id_core][0]);
      mapMuestreoCacheL1[cpid][id_core][tiempothread]=*dataC;
      cout<<"Tiempo: "<<tiempothread<<"-cacheL1 :"<<lecturas[id_core][0]<<", "<<escrituras[id_core][0]<<endl;
  ...
  void mideCacheL2(int cpid,int id_core,double diferencia,double tiempo_total, double tiempothread){
      ...
      dataCache *dataC = new dataCache(tiempoActivo,tiempo_total,lecturas[id_core][1],escrituras[id_core][1]);
      mapMuestreoCacheL2[cpid][id_core][tiempothread]=*dataC;
      cout<<"Tiempo: "<<tiempothread<<"-cacheL2 :"<<lecturas[id_core][1]<<", "<<escrituras[id_core][1]<<endl;
    ...
    void mideCacheL3(int cpid,int id_core,double diferencia,double tiempo_total, double tiempothread){
      ...
      dataCache *dataC = new dataCache(tiempoActivo,tiempo_total,lecturas[id_core][2],escrituras[id_core][2]);
      mapMuestreoCacheL3[cpid][tiempothread][id_core]=*dataC;
      cout<<"Tiempo: "<<tiempothread<<"-cacheL3 :"<<lecturas[id_core][2]<<", "<<escrituras[id_core][2]<<endl;
